...
def round_robin_init():
    ...
    def round_robin():
        ...
        nonlocal v_total_carga
        nonlocal v_vazao
        nonlocal v_total_tempo_execucao
        nonlocal v_uso_cpu
        nonlocal v_tempo_resposta
        nonlocal v_quantum
...
botao = Button(janela, width=50, text='botao', command=round_robin_init, background='green')
